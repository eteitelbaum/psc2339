...
- Pick one country that you think has inclusive institutions and one with extractive institutions
- Based on that country's history and A&R's theory, what do you expect it economic performance to have been over the past half century? 
- Visit the [World Development Indicators](https://databank.worldbank.org/source/world-development-indicators)
- Select your countries
- Select GDP per capita in constant US$
- Select all the years
- Update and select "Chart"
- Do your countries fit your expectations? A&R's theory? 
- If there are discrepancies, why do you think that is?

# Remaining Challenges

## Extractive Institutions in the U.S.
...
::: notes
- How does colonialism factor into A&R's theory of institutions and
development? 
- If a country engages in colonialism, can we really call it "inclusive"? How much of Britain's wealth can be attributed to its colonies? 
- This is a crucial question because Britain lies at the heart of A&R's theory. 
:::
...
::: notes
-   Relatedly, India is an interesting case because it the British ruled with extractive institutions but also established some inclusive political and economic institutions (e.g. railroads, legal system, property rights, parliament)
...
-   The British enacted laws that prevented Indian industry from
