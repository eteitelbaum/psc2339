...
## 1. Selective Incentives {.smaller}
...
![Source: Habyarimana et. al., 2007](images/table_1.1.png)

## Four Types of Games {.smaller}
...
![Source: Habyarimana et. al., 2007](images/figure_4.1.jpg)

## Dictator Game (anonymous)

![Source: Habyarimana et. al., 2007](images/figure_4.2.jpg)
...
## Encompassing Ethnic Parties {.smaller}

<br>

::: columns
::: {.column width="50%"}
![Source: Thachil and Teitelbaum,
2015](images/TT_findings.png){width=60%}
:::
...
::: {.column width="50%"}
![Source: Wikimedia commons](images/lebanon.png){width=70%}
:::
:::

# Agency

## Miguel Study {.smaller}
