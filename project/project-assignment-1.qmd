...
project. The final project is going to involve creating a dashboard in
Tableau. You can find some examples of Tableau dashboards
[here](https://www.tableau.com/data-insights/dashboard-showcase).
...
Please upload your assignment as a .pdf document to Blackboard. You will
find the link to upload the assignment in the Assignments section of the
Blackboard site.
